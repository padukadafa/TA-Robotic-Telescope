...
% Set jenis dokumen Tugas Akhirfvrrrrrrrrrrrr 
...
% 	\rfoot{Halaman \thepage}%
    ...
    % Judul Tugas Akhir
    \title{Pengembangan Teleskop Robotik Berbasis \textit{IoT} yang Terintegrasi dengan \textit{Computer Vision} untuk Deteksi dan Identifikasi Objek Astronomi} % Judul Tugas Akhir dalam Bahasa Indonesia	
	...
	\dosbingA%
		{Radhinka Bagaskara, S.Si.Kom., M.Si., M.Sc.}%	% Nama Dosen Pembimbing 1
		{NIP. : 19941127 202012 1 018}				% NIP Dosen Pembimbing 1
	\dosbingB%
	...
	\pengujiA%
		{Penguji A}%	% Nama Dosen Penguji 1
		{NIP. 19911127 2022 03 1 007}				% NIP Dosen Penguji 1
	\pengujiB%
		{Penguji B}%	% Nama Dosen Penguji 2
