...
\begin{document}
    ...
    \title{Rancang Bangun Teleskop Robotik \textit{Alt-Azimuth} dengan Optimasi Estimasi Sudut Menggunakan \textit{Mahony Filter} (Studi Kasus OAIL ITERA)}
    % Judul Tugas Akhir dalam Bahasa Inggris
    \titleEN{Design and Development of an Alt-Azimuth Robotic Telescope with Optimized Angle Estimation Using Mahony Filter (Case Study of OAIL ITERA)}
    % JUDUL AKAN DITULIS DALAM HURUF KAPITAL; Font size 16 pt; Bold; Tidak melebihi 4 baris
    
    % Informasi Mahasiswa
	\author{Daniel Ferryal Zuhri}		% Nama Mahasiswa
	\nim{122140114}				% NIM Mahasiswa
	
	%Informasi Dosen Pembimbing
	\dosbingA%
		{Ilham Firman Ashari, S.Kom., M.T.}%			% Nama Dosen Pembimbing 1
		{NIP. 19930314 201903 1 018}	% NIP Dosen Pembimbing 1
%	\dosbingB%
...
%		{NIP. 19900000 2000 00 0 000}	% NIP Dosen Pembimbing 2
	...
	\pengujiA%
		{Prof. Sarwono Sutikno, Dr,Eng., CISA, CISSP, CISM, CSX-F, IIAP, CC.}%				% Nama Dosen Penguji 1
		{NIP. 19591014 198503 1 003}	% NIP Dosen Penguji 1
	\pengujiB%
		{Muhammad Habib Algifari, S.Kom., M.TI.}%				% Nama Dosen Penguji 2
		{NIP. 19910525 202203 1 002}	% NIP Dosen Penguji 2
   ...
   % %----------------------------------------------------------------%
    ...
    \chapter*{Lampiran}
    	...
    	\centering
    	\includegraphics[width=0.6\textwidth]{figure/qr_lampiran.png}
    	\caption{Lampiran}
